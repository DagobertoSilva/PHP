      ...
      <fieldset>
        <div class="container">
          ...
          <p class="text-xl-center">
            <a href="index.html" class="btn btn-sm btn-danger">Sair</a>
            <button type="submit" class="btn btn-sm btn-light">Cadastrar</button>
            <a href="cadastro.php" class="btn btn-sm btn-danger">Cancelar</a>
